...
var BaselineVersions = map[string]int{
	...
	"v0.1.8b": 52,
	"v0.1.8c": 53, // marking an account for deletion instead of removing it (53) // widens translator_applications.languages so a 14 language application fits (48); event reminder subscriptions (49) and several reminders per event (50); provenance on a boxed Pokemon (51); raid boss history as a star schema (52)
}
